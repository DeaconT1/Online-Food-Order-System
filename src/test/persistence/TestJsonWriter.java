...
public class TestJsonWriter extends JsonTest{
    ...
    void testWriteGeneralOrder() {
        try {
            Order order = new Order();
            order.addFoodItem(new FoodItem("MoonCake", "Traditional Chinese food for celebrating mid-autumn festival", 9.99));
            ...
            checkFoodItem("MoonCake", "Traditional Chinese food for celebrating mid-autumn festival", 9.99, Arrays.asList("Nice!!"), f.get(0));
